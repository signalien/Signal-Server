...
public class AccountsManagerTest {
  ...
  public void testGetAccountByNumberInCache() {
    ...
    AccountsManager   accountsManager = new AccountsManager(accounts, directoryManager, cacheCluster, directoryQueue, keys, keysDynamoDb, messagesManager, usernamesManager, profilesManager, secureStorageClient, secureBackupClient);
