...
class DirectoryControllerTest {
  ...
  private static final DirectoryManager                   directoryManager              = mock(DirectoryManager.class);
  ...
  private static final ResourceExtension resources = ResourceExtension.builder()
                                                            ...
                                                            .addResource(new DirectoryController(rateLimiters, directoryManager, directoryCredentialsGenerator))
                                                            .build();
